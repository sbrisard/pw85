...
init_signature(cpw85.pw85__cholesky_decomp, 2*[c_double_p])
init_signature(cpw85.pw85__cholesky_solve, 3*[c_double_p])
init_signature(cpw85.pw85_spheroid, [c_double, c_double, c_double_p, c_double_p])
init_signature(cpw85.pw85_f_neg, [c_double, c_double_p], c_double)
init_signature(cpw85.pw85__residual, [c_double]+4*[c_double_p])
init_signature(cpw85.pw85_contact_function, 4*[c_double_p], c_double)

# spheroid = cpw85.pw85_spheroid
# contact_function = cpw85.pw85_contact_function
# f_neg = cpw85.pw85_f_neg
# f1 = cpw85.pw85_f1
# f2 = cpw85.pw85_f2
...
# init_signature(f1, [c_double] + 4 * [c_double_p], c_double)
# init_signature(f2, [c_double]+4*[c_double_p], c_double)
